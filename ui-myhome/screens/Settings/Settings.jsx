    ...
    <ScrollView vertical className="h-full w-full]">
      <View className="relative flex-row">
        <Image
          ...
          className="h-[405px] w-full relative"
        />
      ...
      <View className="mt-[15px] ml-[30px]">
        ...
        <Text className="font-normal text-[16px] mt-[4px]">
          + $ 90.000 Expensas
        </Text>
        <View className="mt-[10px]">
          <Text className="font-semibold text-[20px]">
            Casa Moderna con Pileta
          </Text>
          <Text className="font-normal text-[14px] mt-[2px]">
      ...
      <View className="w-full items-center justify-center mt-[28px] ">
        <Text className="h-[79px] border-[1px] bg-slate-200 w-full items-center justify-center text-center">
          ACA VAN LAS CARACTERISTICAS (metros2 cantidad de habitacione etc)
        </Text>
      </View>
      ...
      <View className="w-full px-[23px] pt-[20px]">
        ...
        {description.length > 90 && !showFullText && (
          <TouchableOpacity onPress={toggleReadMore}>
            <Text className="text-[#4285F4] font-normal text-[15px]">
              Leer más
            </Text>
          </TouchableOpacity>
        )}
      ...
      <View>
        <View className="flex-row items-center justify-between px-[40px] mt-[38px]">
          ...
          <TouchableOpacity>
            <Text className="text-[15px] font-normal text-[#5D157E] ">
              Ver más
            </Text>
          </TouchableOpacity>
        </View>
        <View className="flex-row px-[23px] justify-between mt-[23px]">
          <TouchableOpacity>
            <Image
              ...
              className="h-[100px] w-[100px] rounded-[20px] relative"
            />
          </TouchableOpacity>
          <TouchableOpacity>
            <Image
          ...
          <TouchableOpacity className="relative items-center justify-center">
            ...
            <Text className="opacity-100 text-white absolute z-[9999] text-[24px] font-bold">
              20+
            </Text>
            <Image
              source={{
