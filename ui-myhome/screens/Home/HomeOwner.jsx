...
const HomeOwner = ({navigation}) => {
    ...
    const [highlightedListings, setHighlightedListing] = useState([].concat(mockedHighlightedListings));
  ...
  return (
    <View>
        <ScrollView vertical className="mt-10">
            ...
            <Text className="font-bold text-[20px] pl-4 mt-6">Mis Publicaciones</Text>
        ...
        <TouchableOpacity   TouchableOpacity onPress={() => navigation.navigate("NewPost")} className="absolute right-3 bottom-3 rounded-full bg-[#6750a4] h-16 w-16 flex items-center justify-center">
